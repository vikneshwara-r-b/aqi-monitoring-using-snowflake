...
create or replace dynamic table fact_city_agg_hour_level
    target_lag='30 min'
...
where 
    city = 'Bengaluru' and 
    MEASUREMENT_TIME ='2024-03-01 11:00:00.000'
order by 
    country, state, city, measurement_time;



create or replace dynamic table fact_city_agg_day_level
    target_lag='30 min'
    warehouse=transform_wh
as 
...
select * from fact_city_agg_day_level limit 10